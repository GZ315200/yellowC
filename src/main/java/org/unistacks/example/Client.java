...
//                //[host[:port]][url-path]
//                sample  ==>  service:jmx:rmi:///jndi/rmi://:" + jmxPort + "/jmxrmi
...
//                service:jmx:rmi:///jndi/rmi://"+host+":"+port+"/XFireMbeanServer
        ...
        //
        ObjectName mbeanName = new ObjectName("org.unistacks.example:type=Hello");
	...
	mbsc.addNotificationListener(mbeanName, listener, null, null);
        ...
        ObjectName mxbeanName =
            new ObjectName("org.unistacks.example:type=QueueSampler");
